...
public class TestingUtils {
   ...
   * @return an Optional containing the first File found in the directory, or an
   *         empty Optional if no files are found
   */
  ...
  /**
   * Checks if a directory contains a specific number of files within a timeout
   * period.
   *
   * @param directoryPath The path of the directory to check.
   * @param expectedCount The expected number of files in the directory.
   * @return true if the directory contains the expected number of files within
   *         the timeout period,
   *         false otherwise.
